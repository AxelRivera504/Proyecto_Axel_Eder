...
CREATE TABLE tbProveedores(
	...
	CONSTRAINT FK_tbProveeor_Dire_Id_tbDirecciones_Dire_Id FOREIGN KEY(Dire_Id) REFERENCES tbDirecciones(Dire_Id)
);
...
ALTER TABLE tbProveedor ADD CONSTRAINT FK_tbProveedor_Usua_IdCreacion_tbUsuarios_Usua_Id FOREIGN KEY(Usua_IdCreacion) REFERENCES tbUsuarios(Usua_Id) 
ALTER TABLE tbProveedor ADD CONSTRAINT FK_tbProveedor_Usua_IdModificacion_tbUsuarios_Usua_Id FOREIGN KEY(Usua_IdModificacion) REFERENCES tbUsuarios(Usua_Id) 
